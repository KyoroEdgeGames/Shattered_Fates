...
UClanDataAsset* UShatteredFatesBlueprintLibrary::LoadClansFromJsonFile(const FString& AbsolutePath)
{
    ...
    // Clans JSON is an object keyed by clan name under "rows" or at root
    ...
    {
        // If not wrapped, treat entire root as rows
...
// Helper to create DataTable from CSV with a specific row struct
